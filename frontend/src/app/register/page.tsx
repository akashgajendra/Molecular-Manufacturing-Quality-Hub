            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2.5">
                  ...
                  <Input {...register("firstName")} className="bg-slate-950 border-slate-800 text-white h-14 px-4 text-base focus:ring-2 focus:ring-indigo-500/50" placeholder="e.g. Elena" />
                ...
                <div className="space-y-2.5">
                  ...
                  <Input {...register("lastName")} className="bg-slate-950 border-slate-800 text-white h-14 px-4 text-base" placeholder="e.g. Vance" />
              ...
              <div className="space-y-2.5">
                ...
                <Input {...register("organization")} className="bg-slate-950 border-slate-800 text-white h-14 px-4 text-base" placeholder="e.g. Vector Bio-Manufacturing Group" />
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2.5">
                  <label className="text-xs font-bold uppercase tracking-widest text-slate-500 ml-1">System ID (Username)</label>
                  <Input {...register("username")} className="bg-slate-950 border-slate-800 text-white h-14 px-4 text-base" placeholder="e.g. evance_qc" />
                ...
                <div className="space-y-2.5">
                  ...
                  <Input {...register("email")} type="email" className="bg-slate-950 border-slate-800 text-white h-14 px-4 text-base" placeholder="e.g. evance@vectorbio.org" />
              ...
              <div className="space-y-2.5">
                ...
                <Input {...register("password")} type="password" className="bg-slate-950 border-slate-800 text-white h-14 px-4 text-base" placeholder="Minimum 8 characters..." />
                {errors.password && <p className="text-indigo-400 text-[10px] uppercase font-bold ml-1">{errors.password.message}</p>}
              </div>

              <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-500 text-white h-16 text-lg font-bold uppercase tracking-widest shadow-xl shadow-indigo-600/20 group mt-4 transition-all duration-300">
